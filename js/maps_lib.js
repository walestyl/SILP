(function (window, undefined) {
    var MapsLib = function (options) {
        ...
        this.googleApiKey = options.googleApiKey || "AIzaSyCtyrVNfw9YO9dEpL7C5C8q9FkfIE1asIQ",
    ...
    if ( $("#cbType3").is(':checked')) tempWhereClause.push("Seafood");
...
//if ( $("#fbType1").is(':checked')) searchType += "1,";
//if ( $("#fbType2").is(':checked')) searchType += "2,";
//if ( $("#fbType3").is(':checked')) searchType += "3,";
